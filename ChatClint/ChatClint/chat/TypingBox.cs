...
namespace chat
{
    public partial class TypingBox : UserControl
    {
        ...
        public delegate void imageClicked(object sender, EventArgs e);
        ...
        public event imageClicked OnImageAttachmentClicked;
        ...
        {
            OnImageAttachmentClicked?.Invoke(sender, e);
        }

        private void richTextBox1_Enter(object sender, EventArgs e)
        {
            richTextBox1.ForeColor = Color.WhiteSmoke;
            if (isEmpty || richTextBox1.Text == "اكتب هنا ...")
            {
                richTextBox1.Text = "";
                isEmpty = false;
            }
        ...
        private void richTextBox1_Leave(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(richTextBox1.Text) || richTextBox1.Text == "اكتب هنا ...")
            {
                isEmpty = true;
                richTextBox1.Text = "اكتب هنا ...";
