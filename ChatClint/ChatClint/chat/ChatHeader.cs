...
namespace chat
{
    public partial class ChatHeader : UserControl
    {
        ...
        public event CallClick OnConectClick;
        ...
        {
            pictureBox4.Image = Resources.icons8_Video_Call_32;
        }

        private void pictureBox4_MouseLeave(object sender, EventArgs e)
        {
            pictureBox4.Image = Resources.icons8_Video_Call_white_32;
        }
        ...
        private void pictureBox3_Click_1(object sender, EventArgs e)
        {
            if(tagle)
            { 
                pictureBox3.Image = Resources.Plane;
                tagle = false;
            }
            else
            {
            ...
            if (OnConectClick != null)
            {
                OnConectClick.Invoke(sender, e);
            }
        }
